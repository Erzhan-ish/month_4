...
def drink_products(request):
    if request.method == 'GET':
        ...
        return render(request,template_name='tags/drink_products.html',context=context)
...
def meal_products(request):
    if request.method == 'GET':
        ...
        return render(request,template_name='tags/meal_products.html',context=context)
